...
checks=[
 ...
 ('linked fee quantity is inspection-only and shows latest resolved pull', 'upstream Fee-stream quantity; edit the source in Fee Product' in html and 'Latest run · resolved pull' in html),
