...
checks=[
 ...
 ('recognition copy separates economic trajectory from NIE timing', 'Controls when the economic expense trajectory hits Noninterest Expense' in html and 'model-period ordinals only' in html and 'First recognition' in html),
 ('Opex UI exposes literal economic commencement separately from recognition', 'Expense begins' in html and 'nieCatFlowStart' in html and 'Economic trajectory is zero before this model period' in html),
