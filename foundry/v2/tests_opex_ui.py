...
checks=[
 ...
 ('linked fee quantity is inspection-only, preserves native units, and shows latest resolved pull', 'upstream Fee-stream quantity; edit the source in Fee Product' in html and 'Latest run · resolved pull' in html and 'Fee-stream quantity · ${esc(drv.source||\'source\')} · ${esc(traj)} · read-only here' in html and 'native units · resolved upstream Series' in html),
