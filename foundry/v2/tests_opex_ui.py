...
checks=[
 ...
 ('Opex can link to CAC-owned AUC by stable Series ID', 'customer_acquisition_auc::' in html and 'AUC (period-end)' in html and 'canonical monthly balance' in html),
 ('AUC-linked Opex multiplier owns an explicit natural rate period', 'nieCatLinkedRatePeriod' in html and all(x in html for x in ['Month','Quarter','Year']) and 'accrues from canonical monthly balances' in html),
