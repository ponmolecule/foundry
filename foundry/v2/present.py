...
BS_LAYOUT = [
    ...
    {"t": "line", "key": "htmBook", "label": "Securities held-to-maturity (designated book), at amortized cost"},
    {"t": "line", "key": "afsBook", "label": "Securities available-for-sale (designated book), at fair value"},
    ...
    {"t": "line", "key": "aoci", "label": "Accumulated other comprehensive income (loss)"},
...
IS_LAYOUT = [
    ...
    {"t": "line", "key": "workforceComp", "label": "Workforce compensation", "indent": 1},
    {"t": "line", "key": "otherOpex", "label": "Other operating expense", "indent": 1},
