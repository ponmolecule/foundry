...
def main():
    ...
    try:
        ...
        need_controls = ["Products", "Balance Sheet", "Income Statement", "Ratios",
                         ...
                         "Net Income by ${PLAB('full').replace(/^./,c=>c.toUpperCase())}",
                         "Tier 1 Leverage Ratio by ${PLAB('full').replace(/^./,c=>c.toUpperCase())}",
