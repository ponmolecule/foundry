...
def from_pf_a(name, fxk):
    ...
    cfg.update({
        ...
        "assumptions": {
            ...
            "cash_target_pct_deposits": g.get("cashFloor", 0)/100.0,
            "cash_yield": g.get("cashYield", 0)/100.0,
            "securities_yield": g.get("secYield", 0)/100.0,
            "borrow_rate_ann": g.get("borrowRate", 0)/100.0,
...
def from_pf_b(name, fxk):
    ...
    cfg.update({
        ...
        "assumptions": {
            ...
            "tax_rate": g.get("taxRate", 21)/100.0,
            "cash_yield": g.get("cashYield", 0)/100.0,
            "sweep_securities_yield": g.get("secYield", 0)/100.0,
